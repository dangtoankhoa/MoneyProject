...
using ezRich.Infrastructure.Data.BoundedContext.Local.Main.UnitOfWork.Migrations;
...
using Infrastructure.Data.Seedwork.EntityFramework.SQLite;
using Infrastructure.CrossCutting.IO;

namespace ezRich.Infrastructure.Data.BoundedContext.Local.Main.UnitOfWork
{
    /// <summary>
    ...
    {
        protected IAppDataStorage AppDataStorage { get; set; }
        ...
        #region Constructor
        public MainBoundContext(IAppDataStorage appDataStorage) : base("LocalDbContext")
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SchemaObject>();
            ...
            Database.SetInitializer(new Configuration(modelBuilder));
        }
